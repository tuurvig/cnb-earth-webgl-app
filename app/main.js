...
define(['json!../data/groups.json'], function(groups) {
    'use strict';
    ...
    const Runtime = {
        ...
        CreateGroupMenuButton: function(group){
            ...
            strong.innerHTML = group.shortcut;
        ...
        UpdateTitle: function(group){
            ...
            titleShort.innerHTML = group.shortcut;
    ...
    require(['InteractableEarth'], function(earth){
        ...
        // upload webgl2 context to a private variable of the searth app
